...
import com.iti_task.finalproject.databinding.ActivityFileIoactivityBinding;
...
public class FileIOActivity extends AppCompatActivity {
    ActivityFileIoactivityBinding binding;
    private final String TAG = "MainActivityTag";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityFileIoactivityBinding.inflate(getLayoutInflater());
